  ...
  return (
    <div className="quizContainer">
      <div className="quisCart">
        <h1>Quiz App</h1>
        <hr />
        {result ? <><h3 className='quizScore'>You Score {score} out of {HtmlData.length}</h3><button onClick={quizRestart} className='quizRestart cursor'>Restart</button></> : <><h2>{index + 1}. {question.question}</h2>
          <ul>
          ...
          <div className="questionIndex">{index + 1} out of {HtmlData.length} questions</div></>}
